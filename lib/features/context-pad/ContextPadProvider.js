...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
  ...
  if (is(bpmnElement, 'bpmn:FlowNode')) {
            ...
            'analyzer': {
                ...
                action: {
                    click: function(event, element) {
                        angular.element('#js-drop-zone').scope().$broadcast('change-analyzer', {
                            event: event,
                            element: element
                        });
                    }
    ...
    if(is(bpmnElement.sourceRef, 'bpmn:ExclusiveGateway') || is(bpmnElement.sourceRef, 'bpmn:InclusiveGateway')) {
        assign(actions, {
            'code': {
                group: 'edit',
                ...
                action: {
                    click: function(event, element) {
                        angular.element('#js-drop-zone').scope().$broadcast('change-condition', {
                            event: event,
                            element: element
                        });
                    }
